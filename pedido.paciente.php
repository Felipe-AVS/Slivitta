...
<head>
    ...
    <title>Meus Pedidos - SlimVitta</title>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="dashboard-card bg-white rounded-2xl p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            $quantidadePedidos = $pedido->SelectQuantidadePedidoPorUsuario($pedido->idusuario);
                            ?>
                            <div class="text-right">
                                <div class="text-2xl font-bold text-neutral-800"><?= $quantidadePedidos; ?></div>
