...
<body class="leading-relaxed">
  ...
  <div class="min-h-screen flex">
      ...
      <div class="w-full max-w-md">
        ...
        <div class="auth-card bg-white rounded-2xl p-8">
          ...
          <div class="text-center mb-8">
            <h2 class="text-2xl font-bold text-neutral-800 mb-2">Acesse sua conta</h2>
          </div>

          <form class="space-y-6" action="./middle/login.php" method="post">
            <!-- Nome Completo -->
            <!-- Telefone -->
            ...
            <div class="form-control">
              ...
              <div class="relative">
                <input type="password" id="senha" name="senha" placeholder="Crie uma senha segura" class="input  bg-neutral-200 input-bordered w-full pl-10 pr-10" required>
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
    ...
    <br>
            <!-- Botão de Registro -->
            <button type="submit" class="btn bg-primary-600 text-white w-full rounded-full py-3 text-lg">
            ...
            <div class="text-center pt-4">
              <p class="text-neutral-600">
                Não tem uma conta?
                <a href="register.php" class="text-primary-600 font-semibold hover:underline">Registre-se</a>
              </p>
            </div>
          </form>
        </div>
